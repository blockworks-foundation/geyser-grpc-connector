...
use yellowstone_grpc_proto::geyser::{
    CommitmentLevel, SlotParallelization, SubscribeRequest, SubscribeRequestFilterBlocks,
    SubscribeUpdate,
};
...
impl GeyserFilter {
    ...
    pub fn blocks_and_txs_with_parallelization(
        &self,
        parallelization_id: i32,
        parallelization_limit: i32,
    ) -> SubscribeRequest {
        let mut blocks_subs = HashMap::new();
        blocks_subs.insert(
            "client".to_string(),
